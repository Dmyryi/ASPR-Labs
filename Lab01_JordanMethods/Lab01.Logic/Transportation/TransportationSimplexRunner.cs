...
public static class TransportationSimplexRunner
{
    public static void Run(TransportationProblem problem, TransportationTrace trace)
    {
        string objective = TransportationLpBuilder.BuildObjectiveText(problem);
        string dualObjective = TransportationLpBuilder.BuildDualObjectiveText(problem);
        string constraints = TransportationLpBuilder.BuildConstraintsText(problem);
